static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_DEWFORD_TOWN - 1] = {MAP_GROUP(DEWFORD_TOWN), MAP_NUM(DEWFORD_TOWN), 1, 10},
    ...
    [HEAL_LOCATION_DEWFORD_GROVE - 1] = {MAP_GROUP(DEWFORD_GROVE), MAP_NUM(DEWFORD_GROVE), 20, 1},
};
