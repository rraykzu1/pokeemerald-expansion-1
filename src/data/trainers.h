const struct Trainer gTrainers[] = {
    ...
    [TRAINER_LEADER_ERIKA] =
    {
        ...
        .trainerName = _("Erika"),
        .doubleBattle = TRUE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY | AI_FLAG_PREFER_STRONGEST_MOVE | AI_FLAG_SMART_SWITCHING | AI_FLAG_HELP_PARTNER,
        .partySize = ARRAY_COUNT(sParty_LeaderErika),
        .party = {.TrainerMon = sParty_LeaderErika},
    }
};
