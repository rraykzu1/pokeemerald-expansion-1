...
static const struct TrainerMonItemCustomMoves sParty_GruntPetalburgWoods[] = {
    ...
    .moves = {MOVE_MEGA_DRAIN, MOVE_PSYBEAM, MOVE_PROTECT, MOVE_LEECH_SEED},
    .abilityNums = 2
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMoves sParty_GruntRusturfTunnel[] = { 
    ...
    .moves = {MOVE_FAKE_OUT, MOVE_GRASSY_GLIDE, MOVE_U_TURN, MOVE_DOUBLE_KICK},
    .abilityNums = 2
    },
    {
    .iv = 255,
    ...
    .moves = {MOVE_BODY_SLAM, MOVE_BITE, MOVE_U_TURN, MOVE_ZEN_HEADBUTT},
    .abilityNums = 1
    },
    {
    .iv = 255,
    ...
    .moves = {MOVE_AIR_CUTTER, MOVE_CALM_MIND, MOVE_ROOST, MOVE_STORED_POWER},
    .abilityNums = 2
    },
    {
    .iv = 255,
    ...
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = {MOVE_PIN_MISSILE, MOVE_ROCK_TOMB, MOVE_KNOCK_OFF, MOVE_AERIAL_ACE},
    .abilityNums = 2
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_BLACK_SLUDGE,
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = {MOVE_POISON_FANG, MOVE_COIL, MOVE_SUCKER_PUNCH, MOVE_ROCK_SLIDE},
    .abilityNums = 0
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .moves = {MOVE_ROCK_TOMB, MOVE_BULLDOZE, MOVE_STEALTH_ROCK, MOVE_THUNDER_WAVE},
    .abilityNums = 0,
    },
    {
    .iv = 255,
    ...
    .moves = {MOVE_PSYBEAM, MOVE_ROCK_TOMB, MOVE_ICY_WIND, MOVE_SWIFT},
    .abilityNums = 0,
    },
    {
    .iv = 255,
    ...
    .moves = {MOVE_BUG_BITE, MOVE_ROCK_TOMB, MOVE_AQUA_JET, MOVE_KNOCK_OFF},
    .heldItem = ITEM_SILVER_POWDER,
    .abilityNums = 0
    },
    {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_MEGA_DRAIN, MOVE_ROCK_TOMB, MOVE_RECOVER, MOVE_INGRAIN},
    .abilityNums = 2
    },
    {
    .iv = 255,
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_TOMB, MOVE_PLUCK, MOVE_BULLDOZE, MOVE_U_TURN}
    },
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = {MOVE_BRICK_BREAK, MOVE_PSYCHO_CUT, MOVE_LIGHT_SCREEN, MOVE_REFLECT},
    .abilityNums = 0
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = {MOVE_BRICK_BREAK, MOVE_KNOCK_OFF, MOVE_FIRE_PUNCH, MOVE_ICE_PUNCH},
    .abilityNums = 2
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMoves sParty_Karen1[] = {
    ...
    .moves = {MOVE_ANCIENT_POWER, MOVE_INCINERATE, MOVE_IRON_HEAD, MOVE_ROCK_TOMB},
    .abilityNums = 0
    },
    {
    .iv = 255,
    ...
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_FIRE_PUNCH, MOVE_BODY_SLAM, MOVE_LOW_SWEEP},
    .abilityNums = 0
    },
    {
    .iv = 255,
    ...
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = {MOVE_KNOCK_OFF, MOVE_THUNDER_WAVE, MOVE_FAKE_OUT, MOVE_DRAIN_PUNCH},
    .abilityNums = 0
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Billy[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BOUNCE, MOVE_FLAIL, MOVE_HYDRO_PUMP, MOVE_FLAIL},
    .abilityNums = 2
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SLUDGE, MOVE_WATER_PULSE, MOVE_SHOCK_WAVE, MOVE_FLIP_TURN},
    .abilityNums = 2
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Tommy[] = {
    ...
    .species = SPECIES_GEODUDE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_TOMB, MOVE_BULLDOZE, MOVE_TACKLE, MOVE_NONE},
    .abilityNums = 0
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BITE, MOVE_ROCK_TOMB, MOVE_NONE, MOVE_NONE},
    .abilityNums = 2
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Joey[] = {
    ...
    .species = SPECIES_MACHOKE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LOW_SWEEP, MOVE_KNOCK_OFF, MOVE_BODY_SLAM, MOVE_KNOCK_OFF},
    .abilityNums = 2
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = {MOVE_BODY_SLAM, MOVE_FAKE_OUT, MOVE_KNOCK_OFF, MOVE_NONE},
    .abilityNums = 1
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Marc[] = {
    ...
    .heldItem = ITEM_NONE,
    .spread = SPREAD_31_IV_0_EV,
    .moves = {MOVE_BULLDOZE, MOVE_ROCK_TOMB, MOVE_TAKE_DOWN, MOVE_NONE},
    .abilityNums = 0
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMoves sParty_Tiana[] = {
    ...
    .species = SPECIES_SHROOMISH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BULLET_SEED, MOVE_TACKLE, MOVE_NONE, MOVE_NONE},
    .abilityNums = 0 
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_James1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BUG_BITE, MOVE_AIR_CUTTER, MOVE_NONE, MOVE_NONE},
    .abilityNums = 0
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Clark[] = {
    ...
    .heldItem = ITEM_HARD_STONE,
    .spread = SPREAD_31_IV_0_EV,
    .moves = {MOVE_ROCK_SLIDE, MOVE_FACADE, MOVE_FIRE_PUNCH, MOVE_NONE},
    .abilityNums = 2
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Darian[] = {
    ...
    .species = SPECIES_ZIGZAGOON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HEADBUTT, MOVE_THIEF, MOVE_PIN_MISSILE, MOVE_NONE},
    .abilityNums = 2
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_NONE,
    .spread = SPREAD_31_IV_0_EV,
    .moves = {MOVE_BIDE, MOVE_PAYBACK, MOVE_TACKLE, MOVE_ROLLOUT},
    .abilityNums = 0
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Devan[] = {
    ...
    .heldItem = ITEM_NONE,
    .spread = SPREAD_31_IV_0_EV,
    .moves = {MOVE_ROCK_SLIDE, MOVE_THUNDER_PUNCH, MOVE_FIRE_PUNCH, MOVE_SUCKER_PUNCH},
    .abilityNums = 0,
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_NONE,
    .spread = SPREAD_31_IV_0_EV,
    .moves = {MOVE_IRON_HEAD, MOVE_ROCK_SLIDE, MOVE_STOMPING_TANTRUM, MOVE_HEADBUTT},
    .abilityNums = 0
    }
};
