...
const u8 gText_DepositPokemon[] = _("Deposite Pokémon");
...
const u8 gText_OptionFontEmerald[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}EMERALD");    //tx_optionsPlus
const u8 gText_OptionFontFireRed[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}FRLG");        //tx_optionsPlus
